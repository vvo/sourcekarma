  ...
  return (
    <>
      <button
        type="button"
        className={cx(
          "inline-flex items-center px-3 sm:px-5 py-1 sm:py-2.5 border border-transparent shadow-sm text-sm sm:text-base font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 relative",
